...
define("DEF_DIR", "./log/");  // 默认将日志文件写在当前目录
...
class Log
{
	...
	/**
	 * 类 Log 构造函数，若参数无效，将会抛出一个Exception异常
	 *
	 ...
	 */
	function __construct($file_prefix = DEF_FILE_PREFIX, $directory = DEF_DIR, $level = DEF_LEVEL, $file_appendix_len = DEF_APPENDIX_LEN , $max_size = DEF_MAX_SIZE)
	{
	...
	/**
	 * reset Log directory for third party game log.
