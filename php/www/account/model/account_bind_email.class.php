...
class c_account_bind_email {
    ...
    function __construct($channel_id, $user_name, $user_email)
    {
        global $g_logger;
        $g_logger = new Log("account_name_eamil_", LOG_DIR);
    ...
    function check_account_bind_email()
    {
        ...
        return db_check_user_email($this->m_channel_id, $user_id, $this->m_user_name, $this->m_user_email, $this->m_client_ip);
    }
}
